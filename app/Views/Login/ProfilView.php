                ...
                <div class="card-block">
                  ...
                  <div class="row">
                    ...
                    <?php else: ?>
                      <div class="col-sm-6">
                        <p class="m-b-10 f-w-600">Phone</p>
                        <a href="<?= base_url('PublicController/ProfilEdit'); ?>"><h6 class="text-muted f-w-400">Lengkapi</h6></a>
                      </div>
                    <?php endif; ?>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      ...
                      <a href="<?= base_url('PublicController/ProfilEdit'); ?>"><h6 class="text-muted f-w-400">Change</h6></a>
                    </div>
                  </div>
                </div>
              </div>
